...
export default function Home() {
  return (
    <main className="w-screen h-screen relative">
      <div
        className="flex items-center w-full h-full bg-cover bg-right md:bg-center "
        style={{ backgroundImage: "url(/main-bg.webp)" }}
      >
        <div className="pl-5 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[50] max-w-[750px]">
          ...
          <div className="flex-col md:flex-row hidden md:flex gap-5 flex-wrap">
            <Link
              href="/my-skills"
      ...
      <div className="absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5">
        ...
        <Link
          href="/public/Hasan-Alhossiny-CV.pdf"
          download={`My_CV`}
          className="rounded-[20px] group bg-trasparent border border-white px-5 py-3 text-lg text-white max-w-[200px]"
        >
          Download CV
